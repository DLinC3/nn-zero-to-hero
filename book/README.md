...
Open a stage for its build and path.
...
| [`08 — tokenizer`](08-tokenizer/) | Byte-level BPE tokenizer |
| [`09 — reproduce GPT-2`](09-reproduce-gpt2/) | GPT-2 training and evaluation pipeline |
| [`10 — deep dive into LLMs`](10-deep-dive-llms/) | End-to-end LLM system model |
| [`Extra — microgpt`](App-microgpt/) | Complete training stack in one file |
